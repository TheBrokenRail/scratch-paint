...
import PenTool from '../helper/tools/pen-tool-two';
import PenModeComponent from '../components/pen-mode-two/pen-mode-two.jsx';

class PenModeTwo extends React.Component {
    ...
    activateTool () {
        ...
        if (strokeColor === MIXED || strokeColor === null) {
            this.props.onChangeStrokeColor(PenModeTwo.DEFAULT_COLOR);
        }
...
const mapDispatchToProps = dispatch => ({
    ...
    handleMouseDown: () => {
        dispatch(changeMode(Modes.PENTWO));
    },
    deactivateTool () {
    },
